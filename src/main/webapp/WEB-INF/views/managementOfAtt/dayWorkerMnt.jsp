...
<div id="content">
    <div class="table-container">
        ...
        <div class="search-container">
            <form action="/dayWorkerMnt" method="get">
                <input name="searchKeyword" id="searchKeyword" type="text"
                    placeholder="검색어 입력">
                <button style="background-color: transparent; border: none;"
                    id="searchButton" type="submit">
                    <img src="<%=request.getContextPath()%>/resources/images/contentimages/search_25.jpg"
                        alt="Search">
                </button>
            </form>
            ...
            <div class="search-container">
                <table class="day-worker-table" border="1">
                    ...
                    <c:forEach items="${list}" var="dayWorker">
                        <tr>
                            <td><input type="checkbox" name="employeeId" value="${dayWorker.employeeId}"></td>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content" >
	    ...
	    <ul id="fieldProjectList" class="part01">
	    	<c:forEach var="feildOrProject" items="${feildOrProjectList}">
	             <li class="p_t5" value="${feildOrProject.feildOrProjectId}">
	             	<span class="updown p_t5">
	             		&nbsp;
	             		<span class="up">
	             			<a>
	             				<img alt="up" src="/resources/images/icon_updown_01.png">
	             			</a>
	             		</span>
	             		<span class="down">
	             			<a>
	             				<img alt="down" src="/resources/images/icon_updown_02.png">
	             			</a>
	             		</span>
	             	</span>
	             	<span class="fpname p_t5"> ${feildOrProject.name}</span>
	             	<span class="m_d p_t5 p_r5">
	             		<a onclick="$.fn.modifyButton()">수정</a>
	             		|
    ...
    <ul class="last">
    	<li>
    		<img src="">
    		<a href="" onclick="$.fn.addButton()">추가하기</a>
    	</li>
    </ul>
    <ul>
    	<li>* 설정하신 순서대로 반영됩니다.</li>
    	<li class="footer c">
    		<span id="resetButton" class="anchor">
