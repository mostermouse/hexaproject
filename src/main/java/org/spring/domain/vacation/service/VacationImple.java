...
public class VacationImple implements VacationService {
	  ...
	  @Setter(onMethod_ = @Autowired)
	    ...
	    @Override
	    public List<VacationDetailsEntity> getFilteredVacationDetails(String status, String employmentType, Long departmentId, Long positionId,String vacationTypeName, String searchKeyword) {
	        return vacMapper.getFilteredVacationDetails(status, employmentType, departmentId, positionId, vacationTypeName, searchKeyword);
