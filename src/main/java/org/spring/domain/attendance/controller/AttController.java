...
public class AttController {
	...
	public String dayWorkerAttendance(@RequestParam("employeeId") Long employeeId, Model model) {
		
		model.addAttribute("dayworkerAttlist", service.getDayWorkerAttendance(employeeId));
